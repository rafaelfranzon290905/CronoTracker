...
export default function SideBar() {
    return (
        <>
        {/* Sidebar */}
      <aside className="w-64 bg-blue-50 shadow-2xl flex flex-col rounded-4xl m-4 hidden md:block">
        <div className="p-6 flex items-center space-x-2 font-bold text-lg">
          <img src={ChronosAzulFundoRemovido} className="h-12 w-12" />
        ...
        <nav className="flex-1 px-4 space-y-2 text-sm">
          ...
          <Link to="/TimeSheet"><Button variant="ghost" className="w-full justify-start"><Clock className="mr-2 h-6 w-6" /> TimeSheet</Button></Link>
