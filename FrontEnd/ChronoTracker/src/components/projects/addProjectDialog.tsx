...
export function AddProjectDialog({ clientes, onSuccess, projectToEdit, variant = "dropdown" }: AddProjectDialogProps) {
  ...
  // Carregar colaboradores globalmente
  useEffect(() => {
  ...
  useEffect(() => {
    if (open) {
      if (projectToEdit) {
        ...
        const idsExistentes = projectToEdit.projeto_colaboradores?.map((pc: any) => pc.colaborador_id) || [];
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="mt-4">
            <Button
              ...
              className="bg-blue-950 rounded-2xl text-white hover:bg-blue-800 w-full"
            >
